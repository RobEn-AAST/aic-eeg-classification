    ...
    def __init__(
        ...
        if read_labels:
            ...
            for subj in os.listdir(task_dir):
                ...
                for sess in os.listdir(subj_dir):
                    ...
                    if not os.path.exists(eeg_fp): continue
        ...
        for _, row in task_df.iterrows():
            ...
            if not os.path.exists(fp):
                print(f"Warning: missing {fp}"); continue
...
def decode_label(idx): return IDX_TO_LABEL[int(idx)]
def encode_label(label): return LABEL_TO_IDX[label]
